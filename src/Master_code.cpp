...
int main() {
    ...
    const char* LOCAL_DIR  = "/home/yangbi/mycobot_ws/src/";               
    // =========================
    ...
    std::string cmd3 =
        ...
        "python3 src/sample_inspect.py "
        "--image ~/mycobot_ws/src/sample_mask.png "
        "--mask  ~/mycobot_ws/src/sample_mask.png "
        "--homography_yaml ~/mycobot_ws/src/homography.yaml "
        "--compare_to    ~/mycobot_ws/src/master_ref/master_features.json "
        "--out_dir       ~/mycobot_ws/src/sample_result "
        "\"";
