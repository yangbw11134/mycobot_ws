...
int main(int argc, char** argv)
{
  ...
  rviz_visual_tools::RvizVisualTools visual_tools("link1", "planning_scene_ros_api_tutorial", node);
  ...
  attached_object.touch_links = std::vector<std::string>{ "gripper_base", "girper_left1", "gripper_right1" };
  ...
  remove_object.header.frame_id = "gripper_base";
