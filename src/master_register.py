...
# ===== 기본 경로 설정 =====
DEFAULT_IMAGE  = "/home/yuni/mycobot_ws/capture_master.jpg"
DEFAULT_MASK   = "/home/yuni/mycobot_ws/sam_output/master_mask.png"
DEFAULT_HOMO   = "/home/yuni/mycobot_ws/homography.yaml"
DEFAULT_OUTDIR = "/home/yuni/mycobot_ws/master_ref"
...
def main():
    ...
    Wc, Hc = out_size
    world_mask = cv2.warpPerspective(mask * 255, Hfinal, (Wc, Hc), flags=cv2.INTER_NEAREST, borderValue=0)
