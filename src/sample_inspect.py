...
def main():
    ...
    # 입력(기본 경로 내장)
    ap.add_argument("--image", default="/home/yuni/mycobot_ws/capture_sample.jpg")
    ap.add_argument("--mask",  default="/home/yuni/mycobot_ws/sam_output/sample_mask.png")
    ap.add_argument("--homography_yaml", default="/home/yuni/mycobot_ws/homography.yaml")
    ap.add_argument("--compare_to", default="/home/yuni/mycobot_ws/master_ref/master_features.json",
                    help="master_features.json 경로")
    ap.add_argument("--out_dir", default="/home/yuni/mycobot_ws/sample_result")
